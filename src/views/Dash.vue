...
.wrapper {
	...
	min-height:500px;
	background:url("../assets/image/wrapper-bg.png") no-repeat;
...
.xpanel-l-t {background-image:url("../assets/image/panel-l-t.png");}
.xpanel-l-b {background-image:url("../assets/image/panel-l-b.png");}
.xpanel-c-b {background-image:url("../assets/image/panel-c-b.png");}
.xpanel-r-t {background-image:url("../assets/image/panel-r-t.png");}
.xpanel-r-m {background-image:url("../assets/image/panel-r-m.png");}
.xpanel-r-b {background-image:url("../assets/image/panel-r-b.png");}
.xpanel .title {
	padding-left:24px;
	height:44px;
	line-height:44px;
...
/* .xpanel .title-long {background-image:url("../assets/image/title-bg-long.png");} */
/* PC */
@media (max-width:1919px) {
